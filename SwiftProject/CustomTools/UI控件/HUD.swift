...
extension UIResponder {
    ...
    func pleaseWaitWithImages(_ imageNames: Array<UIImage>, timeInterval: Int) -> UIWindow{
        return HUD.wait(imageNames, timeInterval: timeInterval)
    }
    // api changed from v3.3
    @discardableResult
    func noticeTop(_ text: String, autoClear: Bool = true, autoClearTime: Int = 1) -> UIWindow{
        return HUD.noticeOnStatusBar(text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    
    // new apis from v3.3
    @discardableResult
    func noticeSuccess(_ text: String, autoClear: Bool = false, autoClearTime: Int = 3) -> UIWindow{
        return HUD.showNoticeWithText(NoticeType.success, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    @discardableResult
    func noticeError(_ text: String, autoClear: Bool = false, autoClearTime: Int = 3) -> UIWindow{
        return HUD.showNoticeWithText(NoticeType.error, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    @discardableResult
    func noticeInfo(_ text: String, autoClear: Bool = false, autoClearTime: Int = 3) -> UIWindow{
        return HUD.showNoticeWithText(NoticeType.info, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    
    // old apis
    @discardableResult
    func successNotice(_ text: String, autoClear: Bool = true) -> UIWindow{
        return HUD.showNoticeWithText(NoticeType.success, text: text, autoClear: autoClear, autoClearTime: 3)
    }
    @discardableResult
    func errorNotice(_ text: String, autoClear: Bool = true) -> UIWindow{
        return HUD.showNoticeWithText(NoticeType.error, text: text, autoClear: autoClear, autoClearTime: 3)
    }
    @discardableResult
    func infoNotice(_ text: String, autoClear: Bool = true) -> UIWindow{
        return HUD.showNoticeWithText(NoticeType.info, text: text, autoClear: autoClear, autoClearTime: 3)
    }
    @discardableResult
    func notice(_ text: String, type: NoticeType, autoClear: Bool, autoClearTime: Int = 3) -> UIWindow{
        return HUD.showNoticeWithText(type, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    @discardableResult
...
class HUD: NSObject {
    ...
    // fix https://github.com/johnlui/HUD/issues/2
    // thanks broccolii(https://github.com/broccolii) and his PR https://github.com/johnlui/HUD/pull/5
    static func clear() {
    ...
    static func noticeOnStatusBar(_ text: String, autoClear: Bool, autoClearTime: Int) -> UIWindow{
        ...
        UIView.animate(withDuration: 0.3, animations: {
            ...
            if autoClear {
                let selector = #selector(HUD.hideNotice(_:))
    ...
    static func showNoticeWithText(_ type: NoticeType,text: String, autoClear: Bool, autoClearTime: Int) -> UIWindow {
        ...
        switch type {
        case .success:
            image = HUDSDK.imageOfCheckmark
        case .error:
            image = HUDSDK.imageOfCross
        case .info:
            image = HUDSDK.imageOfInfo
        }
...
class HUDSDK {
    ...
    class var imageOfCheckmark: UIImage {
        ...
        HUDSDK.draw(NoticeType.success)
